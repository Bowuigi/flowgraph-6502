...
function peg$parse(input, options) {
  ...
  const peg$e4 = peg$literalExpectation("A", false);
  const peg$e5 = peg$literalExpectation(".", false);
  const peg$e6 = peg$literalExpectation("[", false);
  const peg$e7 = peg$literalExpectation("+", false);
  const peg$e8 = peg$classExpectation(["X", "Y"], false, false, false);
  const peg$e9 = peg$literalExpectation("]", false);
  const peg$e10 = peg$classExpectation([["0", "9"], ["a", "f"], ["A", "F"]], false, false, false);
  const peg$e11 = peg$literalExpectation("h", false);
  const peg$e12 = peg$classExpectation([["0", "9"]], false, false, false);
  const peg$e13 = peg$literalExpectation("d", false);
  const peg$e14 = peg$classExpectation([["0", "7"]], false, false, false);
  const peg$e15 = peg$literalExpectation("o", false);
  const peg$e16 = peg$classExpectation(["0", "1"], false, false, false);
  const peg$e17 = peg$literalExpectation("b", false);
  const peg$e18 = peg$classExpectation([["a", "z"], "_"], false, false, false);
  const peg$e19 = peg$classExpectation([["a", "z"], ["0", "9"], "_"], false, false, false);
  const peg$e20 = peg$classExpectation(["\n", "\t", " "], false, false, false);
  const peg$e21 = peg$literalExpectation(";", false);
  const peg$e22 = peg$classExpectation(["\n"], true, false, false);

  function peg$f0(name) {
    return {is: 'label', name};
  }
  function peg$f1(mnemonic, args) {
  ...
  function peg$parseArgument() {
    ...
    if (s0 === peg$FAILED) {
      s0 = peg$parseLiteralArgument();
      if (s0 === peg$FAILED) {
        s0 = peg$parsePointerArgument();
        if (s0 === peg$FAILED) {
          s0 = peg$parseAccumulatorArgument();
        }
      }
    }
  ...
  function peg$parseAccumulatorArgument() {
    let s0, s1;
  ...
  function peg$parsePointerArgument() {
    let s0, s1, s2, s3, s4, s5, s6, s7, s8;
